                    ...
                    <?php foreach ($cart_items as $item): ?>
                        <li>
                            ...
                            <div class="item-info">
                                ...
                                <span class="item-price">Giá: <?php echo number_format($item['price'] * (1 - $item['discount'] / 100), 0, ',', '.'); ?> VND</span>
                            </div>
                        </li>
                    <?php endforeach; ?>
                </ul>
                <div class="total-price">
                    <span>Tổng cộng: <?php echo number_format($total_price, 0, ',', '.'); ?> VND</span>
                </div>
            </div>
